...
function TabKontrol({ db, addRecord, updateRecord, deleteRecord, save }) {
  ...
  const wilayahOpts = (db.wilayah||[]).map(w=>({ value:w.id, label:w.nama }));
  const tokoOpts = (db.toko||[]).filter(t=>t.status==="Aktif").map(t=>({ value:t.id, label:t.nama }));
        ...
        <Modal title={modal==="add"?"Tambah Kontrol Bulanan":"Edit Kontrol Bulanan"} onClose={()=>setModal(null)} width={600}>
          <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr", gap:12, marginBottom:4 }}>
            <div style={{ gridColumn:"1/-1" }}>
              <Input label="Toko" value={form.tokoId} onChange={handleTokoChange} options={tokoOpts} required />
            </div>
                ...
                user ? (
                  <div style={{ display:"flex", alignItems:"center", gap:8 }}>
                    ...
                    <div style={{ fontSize:12, color:"rgba(255,255,255,.9)", fontWeight:600 }}>
                      ...
                      <div style={{ fontSize:10, color:"rgba(255,255,255,.6)", fontWeight:400 }}>☁️ Sinkron aktif</div>
                    </div>
